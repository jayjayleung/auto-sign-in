...
//                page.setUserAgent(userAgent);
//                page.goTo("https://club.yonghongtech.com/thread-110640-1-1.html");
//                Thread.sleep(5000);
//
//                ElementHandle fastpostmessage = page.$("#fastpostmessage");
//                fastpostmessage.type("签到");
//                ElementHandle fastpostsubmit = page.$("#fastpostsubmit");
